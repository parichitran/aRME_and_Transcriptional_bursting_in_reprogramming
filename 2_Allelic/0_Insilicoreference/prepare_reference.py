...
def GATK_SelectVariants(r, v, o, g=None, n=None, b=False):
    ...
    cmd = "/media/gayen/DATA/Projects/IMP/Tools/gatk/gatk SelectVariants -select-type SNP "
    flags = {'-R':r, '-V':v, '-O':o}
    if (g):
        # tmp exons bed file:
...
test_name="/media/gayen/seagate10tb/Extra/Temp"
...
def main():
    ...
    if (args.PSEUDOREF=="True"):
        ...
        if (input_case == "two_alleles" or input_case == "joint_two_alleles" or input_case == "individ" or input_case == "joint_individs"):
            ...
            if (input_case == "two_alleles"):
                snp_mat_vcf = tempfile.NamedTemporaryFile(delete=False, suffix=".vcf", dir=test_name)
                snp_pat_vcf = tempfile.NamedTemporaryFile(delete=False, suffix=".vcf", dir=test_name)
            ...
            if(input_case == "one_allele"):
                snp_alt_vcf = tempfile.NamedTemporaryFile(delete=False, suffix=".vcf", dir=test_name)
    ...
    if (args.HETVCF=="True"):
        ...
        if (input_case == "two_alleles" or input_case == "joint_two_alleles"):
            ...
            # .. to pair (snp):
            pair_vcf = tempfile.NamedTemporaryFile(delete=False, suffix=".vcf", dir=test_name)
            if (input_case == "two_alleles"):
            ...
            # .. to singleton (snp):
            singleton_vcf = tempfile.NamedTemporaryFile(delete=False, suffix=".vcf", dir=test_name)
            if (input_case == "one_allele"):
            ...
            # .. to sep ind vcf (snp):
            sep_vcf_ind = tempfile.NamedTemporaryFile(delete=False, suffix=".vcf", dir=test_name)
            if (input_case == "individ"):
        ...
        if (args.bed is not None or args.gtf is not None):
            if (args.bed is not None):
                ...
                region_bed = tempfile.NamedTemporaryFile(delete=False, suffix=".bed", dir=test_name)
